...
<fieldset>
    <div class="panel">
        <div class="panel-heading">
            <legend> 
                {l s='Product Integration with KeyInvoice' mod='phcxconnector'}
            </legend>
        </div>
        <div class="form-group clearfix">
            <form action="" method="post" id="send-product-keyinvoice" >
                ...
                <div class="submit">
                    <button type="submit" name="process_product_form" class="button btn btn-default button-medium"><span>{l s='Send Product' mod='phcxconnector'} <i class="icon-chevron-right right"></i></span></button>
                </div>
            </form>
        </div>
    </div>
