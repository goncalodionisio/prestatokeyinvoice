...
{if isset($send_to_key_invoice_confirmation)}
    <div class="alert alert-success">{l s='Address Saved' mod='phcxconnector'}</div>
{/if}
...
<div class="col-lg-6">
    <div class="panel">
        <div class="panel-heading">
            <i class="icon-eye"></i>
            {l s='Customer Address Integration with KeyInvoice' mod='phcxconnector'}
        </div>
        <form action="" method="post">
            ...
            <button type="submit" name="keyinvoice_save_address" class="button btn btn-default button-medium">
                <span>
                    {l s='Send to KeyInvoice' mod='phcxconnector'}
