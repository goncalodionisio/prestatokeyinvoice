...
<div class="col-lg-6">
	<div class="panel">
		<div class="panel-heading">
			<i class="icon-eye"></i>
			{l s='Customer Address Integration with KeyInvoice' mod='prestatokeyinvoice'}
		</div>
			...
			<table class="table">
				...
				{foreach $address_list as $address}
					<tr>
						...
						<td>
							<input type="radio" name="keyinvoice_address_radio" value="{$address.id_address}" {if $selected_address eq $address.id_address}checked{/if}>
						</td>
					</tr>
				{/foreach}
				</tbody>
